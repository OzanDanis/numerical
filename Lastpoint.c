...
int menu();
void game(int arr[][MAX], int size, double *score);
int main(){
    ...
    do{
        ...
        if(base_x - dest_x == 0){
            if(dest_y > base_y){
                ...
                tmpscores+=size* (double)(dest_y-base_y);
            }
            else if(base_y > dest_y){
                for(i = 1 ; i <= (base_y-dest_y) ; i++){
                    arr[base_x][base_y-i] = arr[base_x][base_y];
                }
                tmpscores+=size* (double)(base_y-dest_y);
            }
            else{
        ...
        if(dest_y-base_y == 0){
            if(dest_x > base_x){
                ...
                tmpscores+=size*(double)(dest_x-base_x);
            }
            else if (base_x > dest_x)
            {
                for(i = 1 ; i <= (base_x-dest_x); i++){
                ...
                tmpscores+=size*(double)(base_x-dest_x);
            }
            else{
